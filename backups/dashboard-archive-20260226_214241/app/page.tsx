  ...
  return (
    <main className="mx-auto max-w-5xl p-6">
      <header className="mb-6">
        ...
        <p className="mt-1 text-sm text-[color:var(--foreground)]">Select a project to view details (read-only).</p>
      </header>
      ...
      <footer className="mt-8 text-xs text-[color:var(--foreground)]">
